...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    addBtn.addEventListener("click", ()=>{
        ...
        } else toonFormContainer.style.display = "none";
    });
});
//Add Leaderboard (Top 3 Toons!)
fetch(toonDB).then((r)=>r.json()).then((toons)=>{
...
function renderCard(toon) {
    ...
    likesButton.addEventListener("click", ()=>{
        ...
        .then((r)=>r.json()).then(likeCount.textContent = "Total Votes:  " + toon["likes"]);
    });
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequireeb80")
